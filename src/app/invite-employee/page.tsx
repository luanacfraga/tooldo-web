    ...
    const loadCompanies = async () => {
      try {
        ...
        if (user.role === 'admin') {
          ...
          // For non-admins, we would need to get their company from somewhere
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Selecione a empresa para qual o funcionário será convidado
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Empresa <span className="text-danger-base">*</span>
                      </FormLabel>
                      <Select
                      ...
                      <FormDescription>
                        O funcionário terá acesso aos dados desta empresa
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Cargo e função do funcionário na empresa
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Notas internas sobre o funcionário
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
