...
export default function CompanySettingsPage() {
  ...
  return (
    <PageContainer maxWidth="5xl">
      <PageHeader
        title={companyNameFromContext ? `Configurações • ${companyNameFromContext}` : 'Configurações da Empresa'}
        description="Veja os detalhes da empresa e o plano atual vinculado ao administrador."
      />
        ...
        <div className="mt-6 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Informações cadastrais básicas da empresa.</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Dados do administrador dono desta empresa e responsável pela assinatura.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Plano atual vinculado ao administrador desta empresa e os principais limites.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Badge
                  ...
                  className={data.subscription.isActive ? 'bg-emerald-600 hover:bg-emerald-700' : ''}
                >
              ...
              <div className="rounded-lg border border-border/50 bg-muted/40 p-3 text-xs text-muted-foreground flex items-start gap-2">
