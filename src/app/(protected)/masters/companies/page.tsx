...
import { useActiveCompaniesWithPlans, useUpdateCompanyPlan } from '@/lib/services/queries/use-companies'
...
export default function MasterCompaniesPage() {
  const { data: companies = [], isLoading, isFetching, error, refetch } = useActiveCompaniesWithPlans()
